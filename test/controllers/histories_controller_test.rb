...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { action: @history.action, object: @history.object, time: @history.time, user_name: @history.user_name }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { action: @history.action, object: @history.object, time: @history.time, user_name: @history.user_name }
    assert_redirected_to history_path(assigns(:history))
  end
